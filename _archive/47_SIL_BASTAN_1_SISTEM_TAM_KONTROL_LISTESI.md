# 47 SİL BAŞTAN 1 — SİSTEM TAM KONTROL LİSTESİ

**Sürüm:** 7.0 Final | **Tarih:** 2026-03-07 | **Toplam Kriter:** 51
...
| # | Kural | Açıklama |
|---|-------|----------|
| K1 | **Hiçbir madde atlanmaz** | 51 kriter sırayla işlenir. Hızlı geçilemez. |
...
| M2 | **Perplexity / Gemini AI** maliyete değiyor mu? | ☐ | |
...
## QQ. VERİ TAŞINABİLİRLİĞİ VE ÇIKIŞ STRATEJİSİ
>
...
## TT. TELEGRAM BOT İŞLEVSELLİĞİ
>
> *Bot doğru çalışıyor, doğru mesaj gönderiyor mu?*

| # | Kontrol Sorusu | Puan | Not |
|---|----------------|:----:|-----|
| TT1 | Kritik event'lerde (gecikmiş sipariş, düşük FPY, hata) **Telegram mesajı gönderiliyor mu?** | ☐ | |
| TT2 | Gönderilen mesaj **doğru bilgiyi, doğru formatta** içeriyor mu? (kişi/tutar/tarih) | ☐ | |
| TT3 | Mesaj gecikmesi **kabul edilebilir mi?** (anlık olayda <30 saniye) | ☐ | |
| TT4 | Bot token ve chat_id **kodda (hardcoded) değil, .env'de** mi tutuluyor? | ☐ | |

**TT Toplam:** ___/20

---

## UU. ALTYAPI TEKNOLOJİSİ DENETİMİ
>
> *Supabase / Next.js / Sunucu — derinlemesine inceleme*

| # | Kontrol Sorusu | Puan | Not |
|---|----------------|:----:|-----|
| UU1 | Supabase free tier yerine **ücretli plana geçiş eşiği** belirlendi mi? Ne zaman geçilir? | ☐ | |
| UU2 | Next.js sürümü güncel mi? **Deprecation / breaking change riski** var mı? | ☐ | |
| UU3 | Deployment altyapısı (Vercel/self-hosted) **maliyet ve güvenlik** açısından doğru seçim mi? | ☐ | |
| UU4 | Altyapı değişmek zorunda kalınsa **migration planı** var mı? Kaç günde geçilir? | ☐ | |

**UU Toplam:** ___/20

---

## VV. YAPAY ZEKA AJAN TEKNOLOJİSİ
>
> *Gemini / GPT / pgVector / Chatbot API maliyeti ve güvenilirliği*

| # | Kontrol Sorusu | Puan | Not |
|---|----------------|:----:|-----|
| VV1 | Kullanılan AI API'nin (Gemini/GPT) **aylık token maliyeti** ölçülüp takip ediliyor mu? | ☐ | |
| VV2 | pgVector/embedding kullanımı **gerçekten gerekli mi?** Fayda/maliyet oranı pozitif mi? | ☐ | |
| VV3 | AI agent kararları **loglanıyor mu?** Yanlış karar verilince kim fark eder, nasıl düzeltilir? | ☐ | |
| VV4 | Bulut AI yerine **lokal/ücretsiz AI** (Ollama vb.) alternatifi değerlendirildi mi? | ☐ | |

**VV Toplam:** ___/20

---

## WW. KVKK / KİŞİSEL VERİ KORUMA
>
> *Türkiye KVKK kanunu kapsamında işçi verileri yasal mı?*

| # | Kontrol Sorusu | Puan | Not |
|---|----------------|:----:|-----|
| WW1 | İşçi maaşı, SSK, TC kimlik gibi kişisel veriler **KVKK kapsamında korunuyor mu?** | ☐ | |
| WW2 | Veriler hangi sunucuda tutuluyor? **Türkiye sınırları içinde mi?** | ☐ | |
| WW3 | İşçi kendi verisini **görme ve silme hakkını** sistemden kullanabiliyor mu? | ☐ | |
| WW4 | Veri ihlali olursa **72 saat içinde** yetkili kurumlara bildirim yapılabilir mi? | ☐ | |

**WW Toplam:** ___/20

---

## XX. SAHA GERÇEKLİĞİ / FİZİKSEL-DİJİTAL UYUM
>
> *Sistemde yazılan ile atölyede gerçekte olan birbirini yansıtıyor mu?*

| # | Kontrol Sorusu | Puan | Not |
|---|----------------|:----:|-----|
| XX1 | Operatörün sisteme girdiği üretim miktarı **gerçekte yapılanla eşleşiyor mu?** Doğrulama var mı? | ☐ | |
| XX2 | Kumaş/malzeme stoğu sistemde yazan ile **fiziksel rafta olan** aynı mı? | ☐ | |
| XX3 | Fasona gönderilen miktar ile **geri gelen** sistem kayıtlarıyla örtüşüyor mu? | ☐ | |
| XX4 | Bir gün hiç veri girilmezse **sistem gerçeği mi yoksa boşluğu mu** gösteriyor? | ☐ | |

**XX Toplam:** ___/20

---

## YY. İŞÇİ KABUL VE KULLANIM DİRENCİ
>
> *Teknik açıdan mükemmel sistem, işçi kullanmazsa değersizdir.*

| # | Kontrol Sorusu | Puan | Not |
|---|----------------|:----:|-----|
| YY1 | İşçi sistemi **benimsedi mi** yoksa zorla mı kullanıyor? Direniş belirtisi var mı? | ☐ | |
| YY2 | Tablet/telefona alışık olmayan işçi için **arayüz yeterince basit mi?** | ☐ | |
| YY3 | Sistem işçiye **cezalandırma aracı mı** yoksa destek/kolaylık aracı mı izlenimi veriyor? | ☐ | |
| YY4 | İşçilerin şikayet ve önerileri sisteme **geri besleniyor mu?** | ☐ | |
...
```
═══════════════════════════════════════════════════════════════════
KONTROL RAPORU — 47 SİL BAŞTAN 1
═══════════════════════════════════════════════════════════════════
...
> **46 kriter tamamdır. Kontrol başlayabilir.**

---

*Kayıt konumu: `C:\Users\Admin\Desktop\47_SIL_BASTAN_01\47_SIL_BASTAN_1_SISTEM_TAM_KONTROL_LISTESI.md`*
*Tarih: 2026-03-07 | Sürüm: 6.0*
